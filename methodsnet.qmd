...
5. Identify gap in knowledge base and directions for future research
...
## What effect sizes? {.smaler}

The effect size is the unit of analysis in a meta-analysis. 
...
# Machine Learning-Informed Moderator Selection
...
When meta-analyzing existing bodies of literature, there are many between-studies differences

Differences in samples, designs, measurements, and methods

The number of potential moderators is large relative to the number of studies (n<p)


## Curse of Dimensionality

https://cjvanlissa.shinyapps.io/Polynomials/
...
* Compiled code makes this package very fast and easy to install
